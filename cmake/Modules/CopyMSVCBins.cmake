...
if (CMAKE_CONFIGURATION_TYPES MATCHES "Debug")
	file(GLOB FACE_BEAUTY_DEBUG_BIN_FILES
		"${FaceBeautyPath}/lib/win/Debug/bin/*.dll")
endif()

if (CMAKE_CONFIGURATION_TYPES MATCHES "Rel")
	file(GLOB FACE_BEAUTY_RELEASE_BIN_FILES
		"${FaceBeautyPath}/lib/win/Release/bin/*.dll")
endif()

if (CMAKE_CONFIGURATION_TYPES MATCHES "Debug")
	file(GLOB ALIYUN_OSS_SDK_DEBUG_BIN_FILES
		"${AliYunOSSSDKPath}/third_party/lib/Debug/*.dll")
endif()

if (CMAKE_CONFIGURATION_TYPES MATCHES "Rel")
	file(GLOB ALIYUN_OSS_SDK_RELEASE_BIN_FILES
		"${AliYunOSSSDKPath}/third_party/lib/Release/*.dll")
endif()
...
set(ALL_REL_BIN_FILES
    ${ALIYUN_OSS_SDK_RELEASE_BIN_FILES}
    ${FACE_BEAUTY_RELEASE_BIN_FILES}
	${QT_BIN_FILES})

set(ALL_DBG_BIN_FILES
    ${ALIYUN_OSS_SDK_DEBUG_BIN_FILES}
    ${FACE_BEAUTY_DEBUG_BIN_FILES}
	${QT_DEBUG_BIN_FILES})
