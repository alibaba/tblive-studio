...
struct SimpleOutput : BasicOutputHandler {
    ...
    virtual void ConfigVideoEncoderParam() override;
...
void SimpleOutput::ConfigVideoEncoderParam()
{
    obs_data_t *settings = obs_encoder_get_settings(h264Streaming);
    //obs_data_set_default_int(settings, "bitrate", 2500);
    obs_data_set_default_bool(settings, "use_bufsize", App()->mConfig.mUseBuffer);
    obs_data_set_default_int(settings, "buffer_size", App()->mConfig.mBufferSize);
    obs_data_set_default_int(settings, "keyint_sec", App()->mConfig.mKeyIntSec);
    obs_data_set_default_string(settings, "rate_control", App()->mConfig.mRateControl.c_str());
    //obs_data_set_default_string(settings, "preset", "veryfast");
    obs_data_set_default_string(settings, "profile", App()->mConfig.mProfile.c_str());
    obs_data_set_default_string(settings, "tune", App()->mConfig.mTune.c_str());
    obs_data_set_default_string(settings, "x264opts", App()->mConfig.mX264Opts.c_str());
    obs_data_release(settings);
}
...
void AdvancedOutput::ConfigVideoEncoderParam()
{
    obs_data_t *settings = obs_encoder_get_settings(h264Streaming);
    //obs_data_set_default_int(settings, "bitrate", 2500);
    obs_data_set_default_bool(settings, "use_bufsize", App()->mConfig.mUseBuffer);
