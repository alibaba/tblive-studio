...
static void receive_video(void *param, struct video_data *frame)
{
	...
	if (voi->format == VIDEO_FORMAT_NV12) {
		// Face Beauty
		//if (face_beauty_enable) {
		//	setup_face_beauty(voi->width, voi->height);
		//	do_face_beauty(frame->data[0], frame->data[1], voi->width, voi->height);
		//}
		//else {
		//	teardown_face_beauty();
		//}
	}
